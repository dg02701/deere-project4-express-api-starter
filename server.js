...
app.get("/", (req, res) => {
  res.json({ message: "Flashcard express api app is working_2, sir" });
});
...
app.use("/api/userdecks", require("./controllers/userdecksController.js"));

app.listen(process.env.PORT, () => {
  console.log("Nodemon listening, Darryl");
});
